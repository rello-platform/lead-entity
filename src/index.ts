...
const CLASSIFIER_RULES: ReadonlyArray<ClassifierRule> = [
  ...
  {
    pattern:
      /\b(limited\s+partnership|ltd\s+partnership|limited\s+ptnrship|ltd\s+ptnrship|family\s+limited\s+partnership|l\s+p|lp)\b/,
    type: "PARTNERSHIP",
  },
  {
    pattern: /\btrust\b/,
  ...
  {
    pattern:
      /\b(incorporated|incorp|inc|corporation|corp|company|co)\b/,
    type: "CORPORATION",
  },
  {
